...
{ 'type': "integer", },
], }, },'additionalProperties': false, }, },'application/xml': { 'schema': { 'type': "object",'properties': { 'userId': { 'type': "number",'minimum': 1, },'userNm': { 'type': "string",'minLength': 3, },'emailAddrTx': { 'type': "string",'format': "email", },'x-dashes': { 'type': "string", },'$100ok': { 'type': "string", },'x𒐗': { 'type': "number", },'testBoolean': { 'type': "boolean", },'testUnionType': { 'type': ["string","number","null","object","array"], }, }, }, }, }, },'4xx': {  }, },}};
